...
import sys, os
from PyQt5.QtWidgets import QApplication, QTextBrowser, QComboBox, QMainWindow, QAction, qApp, QMessageBox, QLabel, QPushButton, QFileDialog, QTextEdit
...
class Window(QMainWindow):
    ...
    def runpro1(self):
        ...
        for i in temp[0]: #리턴값 넘기기 전에 .. 메뉴 리스트만 뽑아서 콤보박스에 이식하는 코드 추가함
            self.cb3.addItem(i)
        return temp
